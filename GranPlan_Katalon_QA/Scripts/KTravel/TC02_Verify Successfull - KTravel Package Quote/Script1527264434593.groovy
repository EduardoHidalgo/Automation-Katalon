...
String url = CustomKeywords.'package_KTravel_Package.Busqueda.CrearURL'(((domain) as String), ((affiliate) as String), ((language) as String), 
...
CustomKeywords.'package_KTravel_Package.Busqueda.NavegarURL'(url)

CustomKeywords.'package_KTravel_Package.Lista.SeleccionarPaquete'()

CustomKeywords.'package_KTravel_Package.Ficha.SeleccionarHabitacion'()

CustomKeywords.'package_KTravel_Package.Checkout1.AvanzarCheckout1'()

CustomKeywords.'package_KTravel_Package.Checkout2.AvanzarCheckout2'()
