...
/** TC10_Verify Successfull - KTravel Hotel Quote with Addons
 *
...
String Url = CustomKeywords.'package_KTravel_Hotel_with_Addons.Busqueda.CrearURL'(((domain) as String), ((affiliate) as String), ((language) as String), 
...
CustomKeywords.'package_KTravel_Hotel_with_Addons.Busqueda.NavegarURL'(Url)

CustomKeywords.'package_KTravel_Hotel_with_Addons.Lista.SeleccionarHotel'()

CustomKeywords.'package_KTravel_Hotel_with_Addons.Ficha.SeleccionarHabitacion'()

Boolean Shuttle = CustomKeywords.'package_KTravel_Hotel_with_Addons.Checkout1.AvanzarCheckout1'()

CustomKeywords.'package_KTravel_Hotel_with_Addons.Checkout2.AvanzarCheckout2'(Shuttle)
