...
public class Busqueda 
{
	...
	public void NavegarURL(String url)
	{
		...
		WebUI.verifyElementPresent(findTestObject('KMobile/TC11_KMobile Package with Addons/Lista/div_ListMainInfo_Verificar'), 4, FailureHandling.CONTINUE_ON_FAILURE)
