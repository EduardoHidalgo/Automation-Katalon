...
public class Checkout2
{
	...
	public static AvanzarCheckout2()
	{
		...
		else
		{
			...
			WebUI.setText(findTestObject('KMobile/TC02_KMobile Package Quote/Checkout2/input_cl'), 'Prueba')			
			WebUI.setText(findTestObject('KMobile/TC02_KMobile Package Quote/Checkout2/input_cn'), 'Prueba')			
			WebUI.setText(findTestObject('KMobile/TC02_KMobile Package Quote/Checkout2/input_pnmAdult1'), 'Juan')		
			WebUI.setText(findTestObject('KMobile/TC02_KMobile Package Quote/Checkout2/input_plsAdult1'), 'Perez')			
			WebUI.setText(findTestObject('KMobile/TC02_KMobile Package Quote/Checkout2/input_pnmAdult2'), 'Ana')			
			WebUI.setText(findTestObject('KMobile/TC02_KMobile Package Quote/Checkout2/input_plsAdult2'), 'Perez')
			WebUI.setText(findTestObject('KMobile/TC02_KMobile Package Quote/Checkout2/input_pnmAdult3'), 'Pedro')
			WebUI.setText(findTestObject('KMobile/TC02_KMobile Package Quote/Checkout2/input_plsAdult3'), 'Perez')
			WebUI.setText(findTestObject('KMobile/TC02_KMobile Package Quote/Checkout2/input_pnmAdult4'), 'Susana')
			WebUI.setText(findTestObject('KMobile/TC02_KMobile Package Quote/Checkout2/input_plsAdult4'), 'Perez')
			WebUI.setText(findTestObject('KMobile/TC02_KMobile Package Quote/Checkout2/input_plsChild1'), 'Juanito')
			WebUI.setText(findTestObject('KMobile/TC02_KMobile Package Quote/Checkout2/input_pnmChild1'), 'Perez')
			WebUI.setText(findTestObject('KMobile/TC02_KMobile Package Quote/Checkout2/input_em1'), 'prueba@prueba.com')			
			WebUI.setText(findTestObject('KMobile/TC02_KMobile Package Quote/Checkout2/input_ph1'), '1209348756')			
			WebUI.click(findTestObject('KMobile/TC02_KMobile Package Quote/Checkout2/input_pim1'))
