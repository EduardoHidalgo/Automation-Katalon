...
public class Checkout2
{
	...
	public static AvanzarCheckout2()
	{
		...
		else
		{
			...
			WebUI.setText(findTestObject('KMobile/TC10_KMobile Hotel Quote with Addons/Checkout2/input_cn'), 'Prueba')
			WebUI.setText(findTestObject('KMobile/TC10_KMobile Hotel Quote with Addons/Checkout2/input_cl'), 'Prueba')
			WebUI.setText(findTestObject('KMobile/TC10_KMobile Hotel Quote with Addons/Checkout2/input_em1'), 'prueba@prueba.com')
			WebUI.setText(findTestObject('KMobile/TC10_KMobile Hotel Quote with Addons/Checkout2/input_ph1'), '1209348756')	
			WebUI.click(findTestObject('KMobile/TC10_KMobile Hotel Quote with Addons/Checkout2/input_pim1'))
