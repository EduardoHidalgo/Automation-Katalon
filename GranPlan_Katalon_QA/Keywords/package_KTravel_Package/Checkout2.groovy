...
public class Checkout2
{
	...
	{	
		...
		else
		{
			...
			WebUI.setText(findTestObject('KTravel/TC02_KTravel Package Quote/Checkout2/input_rcn'), 'Prueba')			
			WebUI.setText(findTestObject('KTravel/TC02_KTravel Package Quote/Checkout2/input_rcl'), 'Prueba')			
			WebUI.setText(findTestObject('KTravel/TC02_KTravel Package Quote/Checkout2/input_pnmAdult1'), 'Juan')		
			WebUI.setText(findTestObject('KTravel/TC02_KTravel Package Quote/Checkout2/input_plsAdult1'), 'Perez')			
			WebUI.setText(findTestObject('KTravel/TC02_KTravel Package Quote/Checkout2/input_pnmAdult2'), 'Ana')			
			WebUI.setText(findTestObject('KTravel/TC02_KTravel Package Quote/Checkout2/input_plsAdult2'), 'Perez')			
			WebUI.setText(findTestObject('KTravel/TC02_KTravel Package Quote/Checkout2/input_pnmAdult3'), 'Pedro')			
			WebUI.setText(findTestObject('KTravel/TC02_KTravel Package Quote/Checkout2/input_plsAdult3'), 'Perez')
			WebUI.setText(findTestObject('KTravel/TC02_KTravel Package Quote/Checkout2/input_pnmAdult4'), 'Susana')
			WebUI.setText(findTestObject('KTravel/TC02_KTravel Package Quote/Checkout2/input_plsAdult4'), 'Perez')
			WebUI.setText(findTestObject('KTravel/TC02_KTravel Package Quote/Checkout2/input_pnmChild1'), 'Anita')			
			WebUI.setText(findTestObject('KTravel/TC02_KTravel Package Quote/Checkout2/input_plsChild1'), 'Perez')
			WebUI.setText(findTestObject('KTravel/TC02_KTravel Package Quote/Checkout2/input_em1'), 'prueba@prueba.com')			
			WebUI.setText(findTestObject('KTravel/TC02_KTravel Package Quote/Checkout2/input_em2'), 'prueba@prueba.com')			
			WebUI.setText(findTestObject('KTravel/TC02_KTravel Package Quote/Checkout2/input_ph1'), '1209348756')			
			WebUI.click(findTestObject('KTravel/TC02_KTravel Package Quote/Checkout2/input_pim1'))
